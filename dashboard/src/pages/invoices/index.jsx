    ...
    <>
     <SideBar>
      ...
      <div class="grid grid-cols-6 gap-4">
        <div class="col-end-7 col-span-2 ..."><button type="submit" href="/invoices/new" class="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add new invoice</button>
 </div>
      </div>
