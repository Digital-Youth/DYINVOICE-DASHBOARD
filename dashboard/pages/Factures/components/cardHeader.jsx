export default function CardHeader({ value }) {
  ...
  return (
    <div className="px-5 py-6 h-auto">
      <dl>
        <div className="relative h-52 overflow-hidden rounded-lg bg-blue-600 px-4 pb-12 pt-5 shadow-2xl sm:px-6 sm:pt-6 flex flex-col justify-end items-end place-content-end w-full">
